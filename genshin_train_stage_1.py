...
from src.dataset.genshin_image import GenshinImgDataset
...
def log_validation(
    ...
    ref_image_paths = [
        "./Genshin_PV/test_video/Shuishen_img/00001270.jpg",
        "./Genshin_PV/test_video/Naweiya_img/00000530.jpg",
        "./Genshin_PV/raw_image/00023710.jpg",
        "./Genshin_PV/raw_image/00034998.jpg",
    ]
...
def main(cfg):
    ...
    train_dataset = GenshinImgDataset(
